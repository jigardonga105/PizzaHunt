...
function initAdmin(socket) {
  ...
  function renderItems(items) {
    var parsedItems = Object.values(items); //Object.values(obj) return Array without key, that contain only values of obj
...
function updateStatus(order) {
  ...
  statuses.forEach(function (status) {
    ...
    if (dataProp === order.status) {
      stepCompleted = false;
      time.innerText = moment__WEBPACK_IMPORTED_MODULE_3___default()(order.updateAt).format('hh:mm A');
    ...
    return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default().wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            _context2.next = 2;
            return (0,_stripe_stripe_js__WEBPACK_IMPORTED_MODULE_1__.loadStripe)('pk_test_51IteSRSFuWv43Ec8xhCAcFtsZGArYeXc16YtEnEToEms3UjQFhTQRCWxz8vDlXfcGBX3SR7Hw3ZGoM1957UjvstO00qftwexGb');

          case 2:
            stripe = _context2.sent;
            card = null; // function widget() {
            //     let style = {
            //         base: {
            //             color: '#32325d',
            //             fontFamily: '"Helvetica Neue", Helvetica, sans-serif',
          ...
          case 7:
            paymentType.addEventListener('click', function (e) {
